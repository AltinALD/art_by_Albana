/** Shared gallery data + i18n for Albana Osmani */
export const works = [
  {
  ...
  },
  {
    ...
    sq: {
      title: "Lypësi",
      meta: "Vaj në kanavacë · Unike",
      teaser: "Një figurë e përkulur — jo si mungesë, por si dëshmi. ",
      full:
    ...
    en: {
      ...
      meta: "Oil on canvas · Unique",
      teaser: "A curled figure — not as absence, but as witness. ",
      full:
  ...
  },
  {
    ...
    sq: {
      ...
      teaser: "Portokalli që digjet qetë — si kadife e ngrohtë mbi mur. ",
      full:
    ...
    en: {
      ...
      teaser: "Orange that burns quietly — like warm velvet on a wall. ",
      full:
...
export const i18n = {
  sq: {
    ...
    "hero.lede":
      "Hyr në galerinë 3D — rrotullo hapësirën, prek veprat, lexo historitë.",
    "hero.cta1": "Hyr në galerinë 3D",
    ...
    "doc.title": "Albana Osmani — Galeri Arte 3D",
  },
  en: {
    "nav.gallery": "Gallery",
    "nav.artist": "Artist",
    ...
    "hero.lede":
      "Enter the 3D gallery — orbit the room, touch the works, read their stories.",
    ...
    "doc.title": "Albana Osmani — 3D Art Gallery",
  },
};
